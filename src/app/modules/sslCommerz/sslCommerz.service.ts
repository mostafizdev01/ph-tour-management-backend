...
const sslPaymentInit = async (payload: ISSLCommerz) => { // amara to booking theke payment ta korbo. tohon data gula payload a asbe.

    try {
        const data = {  // ssl diye payment korar jonno ai info gula lagbe. ai info example gula ssl er doc er mordhe deuya ase.
